...
# begin: IntLit at 3.21; stackHeight = 0
  ...
  sw $s5, 4($sp)
  sw $t0, (sp)
# end: IntLit at 3.21; stackHeight = 0
# begin: IntLit at 4.25; stackHeight = 0
  li $t0, 18
  subu $sp, $sp, 8
  sw $s5, 4($sp)
  sw $t0, (sp)
# end: IntLit at 4.25; stackHeight = 0
# begin: IntLit at 5.14; stackHeight = 0
  li $t0, 23
  subu $sp, $sp, 8
  sw $s5, 4($sp)
  sw $t0, (sp)
# end: IntLit at 5.14; stackHeight = 0
# begin: IntLit at 7.20; stackHeight = 0
  li $t0, 29
  subu $sp, $sp, 8
  sw $s5, 4($sp)
  sw $t0, (sp)
# end: IntLit at 7.20; stackHeight = 0
  jr $ra
