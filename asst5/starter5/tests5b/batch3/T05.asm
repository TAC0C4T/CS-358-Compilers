...
CLASS_T05TopClass: # ClassDecl at 16.7
  ...
  .word mth_intToString_Lib # MethodDeclNonVoid at 0.0
  .word mth_intToChar_Lib # MethodDeclNonVoid at 0.0
  .word mth_init_T05TopClass # MethodDeclNonVoid at 21.24
...
CLASS_T05Subclass: # ClassDecl at 30.7
  ...
  .word mth_intToChar_Lib # MethodDeclNonVoid at 0.0
  .word mth_init_T05TopClass # MethodDeclNonVoid at 21.24
  .word mth_init2_T05Subclass # MethodDeclNonVoid at 35.24
  .word mth_printAll_T05Subclass # MethodDeclVoid at 45.17
...
CLASS_ARRAY_INT: # ArrayType at 5.13
  .word mth_hashCode_Object # ArrayType at 5.13
  .word mth_equals_Object # ArrayType at 5.13
  .word mth_toString_Object # ArrayType at 5.13
...
mth_main_Main:
  ...
  sw $t0, ($sp)
  jr $ra
mth_init_T05TopClass:
  jr $ra
  subu $sp, $sp, 4
  sw $s2, ($sp)
mth_init2_T05Subclass:
  subu $sp, $sp, 4
  sw $s2, ($sp)
  jr $ra
  subu $sp, $sp, 4
  sw $s2, ($sp)
mth_printAll_T05Subclass:
  li $t0, 2
  subu $sp, $sp, 8
  sw $s5, 4($sp)
  sw $t0, 0($sp)
